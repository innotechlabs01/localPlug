...
| 2 | B10 | Event bus + outbox | 🟡 | — | — | — | EVENT_ARCHITECTURE.md written: Event Taxonomy (3 types), Ownership, Outbox Pattern, Event Bus, Idempotency, Envelope, Consumers, Versioning, Observability, Implementation Plan |

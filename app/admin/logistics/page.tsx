...
export default function LogisticsPage() {
  ...
  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-display-lg text-slate-navy">{t.admin.placeholders.logistics}</h1>
        <p className="text-body-md text-cool-slate-500 mt-1">{t.admin.placeholders.logisticsDesc}</p>
      </div>

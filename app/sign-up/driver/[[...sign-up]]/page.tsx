    ...
    <div style={{ display: 'flex', minHeight: '100vh', background: 'var(--bg-dark)' }}>
      ...
      >
        ...
        <div style={{ position: 'relative', zIndex: 1, textAlign: 'center' }}>
          ...
          <div style={{
            ...
            {['Asignaciones', 'Rutas', 'Ganancias'].map(f => (
              <span key={f} style={{
      ...
      <style>{`
        @media (min-width: 768px) {
          .sign-up-branding { display: flex !important; }
          .sign-up-mobile-logo { display: none !important; }
        }
      `}</style>
    </div>
  )

// Feature-flag registry (boot flags, all DEFAULT OFF). Seed of the flag registry
// (formalized in B24). Runtime configuration boundary — imports nothing from the project.
